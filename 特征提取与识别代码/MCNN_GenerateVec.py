...
'''
model = torch.load('bestmodel_feature', map_location='cpu')
...
testdataSet = FlameSet('F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_STATE_lte4-8',
                        'F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_START_lte4-8',
                        'F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_END_lte4-8')

# testdataSet = FlameSet('F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_STATE_lte3',
#                         'F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_START_lte3',
#                         'F:/王敏/认证/Test/LET3/autocollectaftercoursesync_DCTF_END_lte3')

# testdataSet = FlameSet('F:/王敏/认证/Train/LTE4-8/autocollectaftercoursesync_DCTF_STATE80%',
...
numpy.save("vec_train_lte4-8.npy",vec_out.detach().numpy())
# numpy.save("vec_test_lte3.npy",vec_out.detach().numpy())
# numpy.save("vec_test_lte4-8.npy",vec_out.detach().numpy())
